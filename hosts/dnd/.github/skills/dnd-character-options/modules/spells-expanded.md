# 擴展法術列表（Expanded Spells — XGE & TCE）

本模組收錄《乞丐全書》（XGE）第三章與《塔莎萬事鼎》（TCE）第三章中的新法術資訊。

## XGE 法術（Xanathar's Guide to Everything — Chapter 3: Spells）
...
## TCE 法術與魔法物品（Tasha's Cauldron of Everything — Chapter 3: Magical Miscellany）
...
| --- | --- | --- | --- | --- | --- |
| 0 | *轟雷劍* | Evocation | No | No | Artificer, Sorcerer, Warlock, Wizard |
| 0 | *翠炎劍* | Evocation | No | No | Artificer, Sorcerer, Warlock, Wizard |
| 0 | *閃電牽引* | Evocation | No | No | Artificer, Sorcerer, Warlock, Wizard |
| 0 | *心靈之楔* | Enchantment | No | No | Sorcerer, Warlock, Wizard |
| 0 | *劍刃爆發* | Conjuration | No | No | Artificer, Sorcerer, Warlock, Wizard |
| 1st | *塔莎酸蝕釀* | Evocation | Yes | No | Artificer, Sorcerer, Wizard |
| 2nd | *野獸召喚術* | Conjuration | Yes | No | Druid, Ranger |
| 2nd | *塔莎心靈鞭* | Enchantment | No | No | Sorcerer, Wizard |
| 3rd | *智能壁壘* | Abjuration | Yes | No | Artificer, Bard, Sorcerer, Warlock, Wizard |
| 3rd | *魂靈環繞* | Necromancy | Yes | No | Cleric, Paladin, Warlock, Wizard |
| 3rd | *精類召喚術* | Conjuration | Yes | No | Druid, Ranger, Warlock, Wizard |
| 3rd | *暗影衍體召喚術* | Conjuration | Yes | No | Warlock, Wizard |
| 3rd | *亡靈召喚術* | Necromancy | Yes | No | Warlock, Wizard |
| 4th | *異怪召喚術* | Conjuration | Yes | No | Warlock, Wizard |
| 4th | *構裝體召喚術* | Conjuration | Yes | No | Artificer, Wizard |
| 4th | *元素召喚術* | Conjuration | Yes | No | Druid, Ranger, Wizard |
| 5th | *Summon Celestial* | Conjuration | Yes | No | Cleric, Paladin |
| 6th | *精類召喚術* | Conjuration | Yes | No | Warlock, Wizard |
| 6th | *塔莎超凡形態* | Transmutation | Yes | No | Sorcerer, Warlock, Wizard |
| 7th | *藍紗一夢* | Conjuration | No | No | Bard, Sorcerer, Warlock, Wizard |
| 9th | *災厄之刃* | Conjuration | Yes | No | Sorcerer, Warlock, Wizard |
...
For example, the *火球術* of a wizard with a fondness for storms might erupt to look like burning clouds or a burst of red lightning (without affecting the spell's damage type), while the same wizard's *加速術* spell might limn the target in faint thunderheads.

Alternatively, a cleric who serves a moon god might radiate faint moonlight around their hands when they cast *治療傷勢*, or their *虔誠護盾* might surround the target with glimmering crescent moons.

Further still, a druid could choose a cherry blossom theme for their magic, causing delicate branches and pink leaves to grow when they cast *糾纏術* or *橡棍術*, and their *妖火術* spell could appear more like wind-tossed petals than flames.
