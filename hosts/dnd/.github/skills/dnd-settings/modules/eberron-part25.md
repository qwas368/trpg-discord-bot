...
本部分整理自《艾伯倫：從最終戰爭崛起》（ERLW）第五章，涵蓋龍晶碎片、魔法物品、奧術裝置與日常魔法物品。
...
This device emanates an antimagic field (same effects as the 反魔法结界 spell) in a radius of 1 to 3 miles. The field can be activated or deactivated as an action with a touch by its controller.
