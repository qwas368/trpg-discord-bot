...
本模組整理自《冒險者聯盟》（Adventurers League, AL）官方組織遊玩規則，涵蓋陣營指南、晉升系統、聲望機制與陣營等級福利。
...
| --- | --- |
| Harpers | Musical Instrument, 書法工具, or 易容工具 |
| Order of the Gauntlet | 鐵匠工具, 皮匠工具, 木匠工具, 泥瓦匠工具, Vehicles |
| Emerald Enclave | 草藥工具, 木雕工具, 製圖工具 |
| Lords' Alliance | 珠寶匠工具, 泥瓦匠工具, 領航工具, Painter's supplies, Gaming Set, Any Standard Language |
| Zhentarim | 易容工具, 文書偽造工具, 製毒工具 盜賊工具, |
