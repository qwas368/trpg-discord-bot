...
本模組整理自《艾伯倫：從最終戰爭崛起》（Eberron: Rising from the Last War, ERLW），涵蓋艾伯倫世界概覽、柯瓦雷地名錄、信仰、夏恩城與冒險建構。
...
To create a compelling villain, the DM and players might develop a villain's backstory together. A DM might ask a player: *When you fought in the Last War, Halas Martain served in your unit until he betrayed you. What did he do, exactly?* Likewise, when a pulp villain appears to die, they can devise remarkable escapes from death. Perhaps Halas had a ring that cast an illusion of his death while stabilizing him or cast 羽落術 when he leapt from that tower in Sharn. A DM could engage the players in determining the answer: *It's Halas Martain, all right. How do you think he survived your last encounter?* This collaboration can produce a compelling story and a sense of investment in the world.
...
Artisans called magewrights provide much of this magic. Compared to a wizard or an artificer, a magewright's knowledge of magic is narrow: a locksmith might master the 秘法鎖 and 敲擊術 spells to supplement the use of physical tools; a magewright healer could cast 次級復原術 and 治療傷勢 in addition to using healer's kits and the 醫療 skill. A magewright's casting is also slow and expensive: they typically cast their spells as rituals. They are artisans, not adventurers, and the prosperity of the Five Nations was built on their foundation.
...
If security is particularly important, House Sivis can protect written messages using magic, such as the 迷幻手稿 spell, and House Kundarak can secure packages with the 守衛銘文 spell.
...
| Service | Cost |
| --- | --- |
| 秘法鎖 (House Kundarak) | 20 gp |
| Courier service (House Orien) | 1 sp per mile |
| 守衛銘文 (House Kundarak) | 350 gp |
| 迷幻手稿 (House Sivis) | 15 gp |
...
The dragonmarked House Jorasco maintains houses of healing across Khorvaire. The simplest service is the expert application of the 醫療 skill. For those with desperate need and gold to pay, most Jorasco outposts can provide 次級復原術; the best healers can also provide 高等復原術. In the finest Jorasco enclaves, it's even possible to raise the dead.
...
| Service | Cost |
| --- | --- |
| Minor nonmagical care | 3 sp per use of the 醫療 skill |
| Major nonmagical care | 1 gp per day |
| 治療傷勢 | 25 gp per level of the spell |
| 次級復原術 | 50 gp |
| 移除詛咒 | 75 gp |
| 高等復原術 | 150 gp |
| 喚醒死者 | 750 gp |
...
| 傳送法陣 (House Orien) | 2,500 gp | Instant |

##### Warfare

After a century of war, magic plays an ever-increasing role on the battlefield. Massive magical siege staffs fill the role of artillery. Semi-sentient warforged titans can scatter squads of infantry. Arcane sappers may spread Glyph of Warding||glyphs of warding to deny a region to an enemy. Wands and rods haven't replaced the swords or bows, but elite wandslingers, as military spellcasters are often known, are becoming ever more common.
