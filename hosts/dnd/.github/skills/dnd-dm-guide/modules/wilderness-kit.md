# 荒野工具包（Wilderness Kit）

*來源：DM 帷幕荒野工具包（DM Screen Wilderness Kit）*

本模組包含荒野旅程與荒野追逐的規則，適用於戶外冒險中的旅行、補給追蹤、隨機遭遇與追逐戰。

---

# 荒野旅程（Wilderness Journeys）
...
- **2. Pace.** The players choose the group's travel pace for the cycle: slow, normal, or fast. See the Travel Pace table on the DM screen for details about each pace.
...
- **6. Progress.** Track the party's progress in miles for the cycle. You may use a hex map in this kit to keep track of the party's current location.
...
- Traveling at night, even with light sources or darkvision（黑暗視覺）.
- Dense forest
- Traveling underground
- Traveling at sea while unable to see the sky or any familiar land.

The DM lets the group know when they are in one or more of those circumstances, and then the characters choose one of their number who must make a Wisdom (Survival（生存）) check against a DC appropriate to the terrain (see "Wilderness navigation" on the DM's screen). Other members of the group can take the Help（協助）action on this check as normal, and traveling at a fast pace imposes disadvantage on the check.
...
| 17 | Field of petrified（石化）soldiers or other creatures |
| 18 | Forest of petrified（石化）or awakened trees |
| 19 | Canyon containing a dragons' graveyard |
| 20 | Floating earth mote with a tower on it |

## 食物與飲水（Food and Water）
...
A character unable to eat or drink gains 1 level of exhaustion（力竭）for each requirement they fail to meet. Exhaustion gained in this way can't be removed until the character is able to consume sufficient food and water.

## 覓食（Foraging）

Characters can hunt or gather food and water while the party travels at a normal or slow pace. A foraging character makes a Wisdom (Survival（生存）) check against a DC determined by the terrain (see the Foraging table on the DM's screen). On a successful check, the character gathers units of food equal to 1d6 + their Wisdom modifier. Repeat the roll for drinkable water.

---

# 荒野追逐（Wilderness Chases）

When a chase begins in the wilderness, the DM can use these rules to determine whether the pursuer catches their quarry.

## 進行追逐（Playing a Chase）
...
- **4. Move and take an action.** You can take one action on your turn, and before or after that action, you can move up to a distance equal to your speed. See the "Actions in Combat" sheet for the actions you can take during a chase (see the "Dashing" section below if you take the Dash（疾走）action). If you have a bonus action available, you also take it during your turn, but no more than once on each of your turns.
- **5. Begin the next round.** When everyone involved in the chase has had a turn, the round ends, and the DM determines whether the chase ends, as detailed in the "Ending a Chase" section below. If the chase doesn't end, repeat steps 3\u20145 until it does.

### 荒野追逐意外（Wilderness Chase Complications）

| d20 | Complication |
| --- | --- |
| 1 | Your path takes you through a rough patch of brush. Make a DC 10 Strength (Athletics（運動）) or Dexterity (Acrobatics（體操）) check (your choice) to get past the brush. On a failed check, the brush counts as 5 feet of difficult terrain. |
| 2 | Uneven ground threatens to slow your progress. Make a DC 10 Dexterity (Acrobatics（體操）) check to navigate the area. On a failed check, the ground counts as 10 feet of difficult terrain. |
...
| 4 | A stream, ravine, or rock bed blocks your path. Make a DC 10 Strength (Athletics（運動）) or Dexterity (Acrobatics（體操）) check (your choice) to cross the impediment. On a failed check, the impediment counts as 10 feet of difficult terrain. |
| 5 | Make a DC 10 Constitution saving throw. On a failed save, you are blinded（目盲）by blowing sand, dirt, ash, snow, or pollen until the end of your turn. While blinded（目盲）in this way, your speed is halved. |
| 6 | A sudden drop catches you by surprise. Make a DC 10 Dexterity saving throw to navigate the impediment. On a failed save, you fall 1d4 × 5 feet, taking 1d6 bludgeoning damage per 10 feet fallen as normal, and land prone（伏地）. |
| 7 | You blunder into a snare. Make a DC 15 Dexterity saving throw. On a failed save, you are caught in the snare and restrained（束縛）. As an action, you or someone within 5 feet of you can make a DC 10 Strength check, freeing you on a success. The snare can also be destroyed; it has an AC of 10 and 5 hit points, and it is immune to poison and psychic damage. |
...
| 10 | One or more creatures in the area chase after you! The DM chooses these pursuers or rolls a d8 to determine them: (1) 2 brown bears, (2) 2d4 giant toads, (3) 1d4 poisonous snakes, (4) 2d4 wolves, (5) 1 giant boar, (6) 2 dire wolves, (7) griffon, or (8) 1d12 giant rats (see the Monster Manual for the creatures' game statistics). |
| 11\u201320 | No complication. |

### 疾走（Dashing）

Over the course of a chase, you can take the Dash（疾走）action a limited number of times before you risk exhaustion（力竭）. That number equals 3 + your Constitution modifier. Each additional Dash（疾走）action you take after that number during the chase requires you to succeed on a DC 10 Constitution check at the end of your turn or gain 1 level of exhaustion（力竭）.

You drop out of the chase if your exhaustion（力竭）reaches level 5, since your speed becomes 0. By finishing a short or long rest, you can remove all the levels of exhaustion（力竭）you gained by taking the Dash（疾走）action additional times during the chase.
...
If neither side gives up the chase, the quarry can make a Dexterity (Stealth（隱匿）) check at the end of each round, after every participant in the chase has taken a turn. An incapacitated（無力）quarry can't make this check, nor can a quarry without anything to hide behind. The check's total is compared to the passive Wisdom (Perception（察覺）) scores of the pursuers. If the quarry consists of multiple creatures, they all make the check. If the total of a quarry's check is greater than the highest passive score, that quarry escapes and is no longer in the chase.
...
| The lead pursuer is a ranger or has proficiency in Survival（生存） | Disadvantage |
